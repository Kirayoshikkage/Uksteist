...
const watchFiles = () => {
  ...
  watch([paths.srcFullJs, `!${srcFolder}/js/**/*.test.js`], scripts);
  watch(`${paths.srcPartialsFolder}/*.html`, htmlInclude);
  watch(`${srcFolder}/*.html`, htmlInclude);
  watch(`${paths.resourcesFolder}/**`, resources);
  watch(`${paths.srcImgFolder}/**/**.svg`, images);
...
const cache = () => {
  return src(
    [
      `${buildFolder}/**/*.{css,js,svg,webp,avif,woff2}`,
      `!${srcFolder}/js/**/*.test.js`,
    ],
    {
      base: buildFolder,
    }
